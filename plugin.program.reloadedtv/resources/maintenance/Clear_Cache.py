...
addon10='-'
# Not Needed
TVGuide1="plugin.program.reloadedtv"
TVGuide2="plugin.program.reloadedtv.Extra"
TVGuide3="plugin.program.reloadedtv.UK"
TVGuide4="plugin.program.reloadedtv.Sports"    
TVGuide5="plugin.program.reloadedtv.Stalker"
...
addon = "plugin.program.reloadedtv";icon = xbmc.translatePath(os.path.join('special://home/addons', addon, 'icon.png'))
#xbmc.executebuiltin('Notification(addonname,"Cache cleared.",icon)')
xbmc.executebuiltin('Notification(%s, %s, %d, %s)'%(addon,"Cache cleared.",3000, icon))  
