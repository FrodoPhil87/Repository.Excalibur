...
def Run_scraper(urlpath,addon_name,username,password,provider):
    ...
    if args.ini_file:
      ...
      xbmc.executebuiltin('Notification(%s, %s, %d, %s)'%("[COLOR red]Reloaded TV Guide[/COLOR]",args.ini_file+" done.",3000, icon))
      sys.exit()
    ...
    xbmc.executebuiltin('Notification(%s, %s, %d, %s)'%("[COLOR red]Reloaded TV Guide[/COLOR]",args.output_fn+" done.",3000, icon))
    sys.exit()
    #
    # append to addon.ini
...
def Copy_Favs_ini(Dest_File):
    ...
    #
    a=open(Dest_File,"a")
    #a.write('[plugin.program.reloadedtv] \n')
    #a.write('['+addon_name+'] \n;'+provider+'\n')
    a.write('[plugin.program.reloadedtv]') 
    a.write(s)
    a.close()  
...
def Clean_Names(Clean_Name,tmpFile):
     ...
     xbmc.executebuiltin('Notification(%s, %s, %d, %s)'%("[COLOR red]Reloaded TV Guide[/COLOR]","Done.",3000, icon))
